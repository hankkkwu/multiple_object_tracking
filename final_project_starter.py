...
def main(input_image):
    ...
    if idx == 0:
      ...
      for obj in selected_obstacles:
        ...
        image = cv2.rectangle(image, (left, top), (right, bottom), color, thickness=1)
        text = "{}".format(new_idx)
        image = cv2.putText(image, text, (left, top), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
white_clip.write_videofile("./Images/MOT16-14-raw_out608.mp4",audio=False)
